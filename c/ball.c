...
// You want to purchase a squirt gun with your tickets. Given your score, and the price of the squirt gun (in tickets) are you able to buy it?
//
// Task 
...
int main()
{
	const int tickets_const = 12;

	int pts;
	int pts_to_tickets;
	int tickets_requried;

	scanf("%d", &pts);
	scanf("%d", &tickets_requried);

	pts_to_tickets = pts / tickets_const;
	
	if (tickets_requried <= pts_to_tickets)
	{
		printf("Buy it!");
	}
	else 
